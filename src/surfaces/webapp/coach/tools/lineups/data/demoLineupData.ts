...
export const DEMO_ATHLETES: DemoAthlete[] = [
  mkAthlete('a-wheeler',     'Marnie Rothmore',            'starboard', '6:35.6', 395.6, 78,  0),
  mkAthlete('a-irmler',      'Brielle Whitcombe',            'port',      '6:38.6', 398.6, 85,  1),
  mkAthlete('a-abbott',      'Freya Birchwood',             'starboard', '6:41.7', 401.7, 91,  2),
  mkAthlete('a-miller',      'Sloane Carrow',             'port',      '6:44.9', 404.9, 62,  3),
  mkAthlete('a-roth',        'Larkin Tremaine',             'starboard', '6:48.1', 408.1, 88,  4),
  mkAthlete('a-cox',         'Delphine Brambleton',            'port',      '6:48.9', 408.9, 42,  5),
  mkAthlete('a-bouman',      'Odette Oakden',            'starboard', '6:50.0', 410.0, 91,  6),
  mkAthlete('a-crampin',     'Marisol Ulverton',            'port',      '6:55.8', 415.8, 55,  7),
  mkAthlete('a-johnson',     'Odile Ashcombe',          'cox',       'cox',    9999,  77,  8),
  mkAthlete('a-vanw',        'Corin Wexford',    'starboard', '6:45.6', 405.6, 82,  9),
...
export const SUGGESTED_1V: { seat: string; name: string; warn: boolean }[] = [
  { seat: 'Cox',     name: 'Odile Ashcombe',        warn: false },
  { seat: '8 · STR', name: 'Odette Oakden',          warn: false },
  { seat: '7',       name: 'Marisol Ulverton',           warn: false },
  { seat: '6',       name: 'Marnie Rothmore',           warn: false },
  { seat: '5',       name: 'Brielle Whitcombe',           warn: false },
  { seat: '4',       name: 'Freya Birchwood',            warn: false },
  { seat: '3',       name: 'Sloane Carrow',            warn: true  },
  { seat: '2',       name: 'Larkin Tremaine',            warn: false },
  { seat: '1 · BOW', name: 'Corin Wexford',   warn: false },
]
...
export const HISTORY_ENTRIES: HistoryEntry[] = [
  {
    ...
    lineup1V: [
      { seat: 'Cox',     name: 'Odile Ashcombe' },
      { seat: '8 · STR', name: 'Odette Oakden' },
      { seat: '7',       name: 'Marisol Ulverton' },
      { seat: '6',       name: 'Marnie Rothmore' },
      { seat: '5',       name: 'Brielle Whitcombe' },
      { seat: '4',       name: 'Freya Birchwood' },
      { seat: '3',       name: 'Sloane Carrow',    swappedIn: true },
      { seat: '2',       name: 'Larkin Tremaine' },
      { seat: '1 · BOW', name: 'Corin Wexford' },
    ],
    lineup2V: [
      ...
      { seat: '3',       name: 'Delphine Brambleton',   swappedIn: true },
  ...
  },
  {
    ...
    lineup1V: [
      ...
      { seat: '5',       name: 'Brielle Whitcombe' },
      { seat: '4',       name: 'Freya Birchwood' },
      { seat: '3',       name: 'Larkin Tremaine' },
      { seat: '2',       name: 'Sloane Carrow' },
      { seat: '1 · BOW', name: 'Corin Wexford' },
    ],
    lineup2V: [
      { seat: 'Cox',     name: 'Casey Morgan' },
      ...
      { seat: '5',       name: 'Madison Ng' },
      { seat: '4',       name: 'Isabel Flores' },
      { seat: '3',       name: 'Delphine Brambleton' },
      { seat: '2',       name: 'Petra Hansen' },
      { seat: '1 · BOW', name: 'Bree Stone' },
    ],
    swaps: null,
  },
  {
    ...
    lineup1V: [
      ...
      { seat: '8 · STR', name: 'Odette Oakden' },
      { seat: '7',       name: 'Marisol Ulverton' },
      { seat: '6',       name: 'Marnie Rothmore',   swappedIn: true },
      { seat: '5',       name: 'Brielle Whitcombe' },
      { seat: '4',       name: 'Freya Birchwood' },
      { seat: '3',       name: 'Larkin Tremaine' },
      { seat: '2',       name: 'Sloane Carrow' },
  ...
  },
  {
    ...
    lineup1V: [
      ...
      { seat: '4',       name: 'Freya Birchwood' },
      { seat: '3',       name: 'Larkin Tremaine' },
      { seat: '2',       name: 'Corin Wexford' },
      { seat: '1 · BOW', name: 'Sloane Carrow' },
    ],
    lineup2V: [
      { seat: 'Cox',     name: 'Casey Morgan' },
      { seat: '8 · STR', name: 'Sophia Bell' },
  ...
  },
  {
    ...
    lineup1V: [
      { seat: 'Cox',     name: 'Odile Ashcombe' },
      { seat: '8 · STR', name: 'Odette Oakden' },
      { seat: '7',       name: 'Marnie Rothmore' },
      { seat: '6',       name: 'Marisol Ulverton' },
      { seat: '5',       name: 'Brielle Whitcombe' },
      { seat: '4',       name: 'Freya Birchwood' },
      { seat: '3',       name: 'Larkin Tremaine' },
      { seat: '2',       name: 'Sloane Carrow' },
