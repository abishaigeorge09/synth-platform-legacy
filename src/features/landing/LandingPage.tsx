...
const TEAM = [
  ...
  { name: 'Matthew Waddell', role: 'co-founder & COO',  image: '/team/matthew.png',  focus: '22% 35%', cred: ['2025 U23 Worlds silver · NZ rowing', 'Cal Rowing · admitted Cambridge'] },
          ...
          {TEAM.map((m, i) => (
            ...
            >
              <div
                ...
                style={{ aspectRatio: '1 / 1', background: ELEVATED, border: `1px solid ${HAIR}` }}
              >
                <img
                  src={m.image}
                  alt={`${m.name} portrait`}
                  ...
                  loading="lazy"
                />
                {/* subtle dark wash so text below pops off the card visually */}
                <div
                  className="absolute inset-0"
