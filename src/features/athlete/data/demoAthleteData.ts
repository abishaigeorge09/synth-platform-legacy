...
export const WORKBOOK_SHEETS = {
  'Erg Log': [
    ['Port', 'Star Miller', '6:44.9', '1:41.2', '337', '35'],
    ['Starboard', 'Lily Abbott', '6:42.8', '1:40.7', '342', '35'],
    ['Port', 'Ella Wheeler', '6:43.5', '1:40.9', '340', '35'],
    ['Starboard', 'Julia Irmler', '6:45.1', '1:41.3', '336', '34'],
    ['Port', 'Olivia Roth', '6:46.3', '1:41.6', '333', '34'],
    ['Starboard', 'Madeline Cox', '6:47.2', '1:41.8', '331', '34'],
    ['Port', 'Minou Bauman', '6:47.8', '1:41.9', '329', '34'],
    ['Starboard', 'Lola Crampin', '6:48.1', '1:42.0', '328', '33'],
  ...
  "8.25 30'": [
    ['Port', 'Star Miller', "7912", '1:53.8', '211', '20'],
    ['Starboard', 'Lily Abbott', '8026', '1:52.2', '218', '20'],
    ['Port', 'Ella Wheeler', '7991', '1:52.7', '216', '20'],
    ['Starboard', 'Julia Irmler', '7933', '1:53.5', '212', '20'],
    ['Port', 'Olivia Roth', '7882', '1:54.2', '208', '20'],
    ['Starboard', 'Madeline Cox', '7859', '1:54.6', '206', '20'],
  ],
  "8.28 3x15'": [
    ['Port', 'Star Miller', '1:49.8', '1:49.2', '1:48.9', '26'],
    ['Starboard', 'Lily Abbott', '1:48.7', '1:48.3', '1:47.9', '27'],
    ['Port', 'Ella Wheeler', '1:49.0', '1:48.6', '1:48.2', '27'],
    ['Starboard', 'Julia Irmler', '1:49.7', '1:49.1', '1:48.8', '26'],
    ['Port', 'Olivia Roth', '1:50.1', '1:49.6', '1:49.2', '26'],
    ['Starboard', 'Madeline Cox', '1:50.3', '1:49.8', '1:49.5', '26'],
  ],
} as const
...
export const LINEUP_ENTRIES = [
  {
    ...
    seats: [
      ...
      { seat: '2', side: 'Stbd', name: 'Julia Irmler' },
      { seat: '3', side: 'Port', name: '★ Star Miller', highlight: true },
      { seat: '4', side: 'Stbd', name: 'Lily Abbott' },
      { seat: '5', side: 'Port', name: 'Olivia Roth' },
      { seat: '6', side: 'Stbd', name: 'Madeline Cox' },
      { seat: '7', side: 'Port', name: 'Minou Bauman' },
      { seat: 'Str', side: 'Stbd', name: 'Lola Crampin' },
      { seat: 'Cox', side: '—', name: 'Charly Johnson' },
    ],
  },
  {
    id: 'l2',
