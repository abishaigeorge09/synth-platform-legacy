  ...
  const athleteItems: PaletteItem[] = [
    {
      ...
      section: 'Navigate',
      keywords: 'athlete home my team dashboard',
      Glyph: DashboardIllustration,
      run: () => go('/athlete/home'),
    },
    {
      id: 'nav-athlete-stats',
      label: 'My stats',
      description: 'Personal stats + trends',
      section: 'Navigate',
      keywords: 'athlete stats trends performance',
      Glyph: AthletesIllustration,
      run: () => go('/athlete/stats'),
    },
    {
    ...
    {
      id: 'nav-athlete-sources',
      label: 'My sources',
      description: 'Connected data sources',
      section: 'Navigate',
      keywords: 'athlete sources connectors data',
      Glyph: SourcesIllustration,
      run: () => go('/athlete/sources'),
    },
    {
      id: 'nav-athlete-ai',
      label: 'My chat',
      description: 'Athlete-scoped synth. AI',
      section: 'Navigate',
      keywords: 'athlete ai chat assistant synth',
      Glyph: SynthAiIllustration,
      run: () => go('/athlete/ai'),
    },
    {
